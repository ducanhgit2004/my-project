  ...
  return (
    ...
    <footer className='py-6 bg-[#fafafa]'>
        <div className="container">
            ...
            <div className="col flex items-center justify-center flex-col group w-[15%]">
                   <PiKeyReturn className='text-[40px] transition-all duration-300
                    group-hover:text-[#ff5252] group-hover:translate-y-1'/>
                ...
                <div className="col flex items-center justify-center flex-col group w-[15%]">
                   <GoGift className='text-[40px] transition-all duration-300
                    group-hover:text-[#ff5252] group-hover:translate-y-1'/>
                   <h3 className='text-[16px] font-[600] mt-3'>Special Gifts</h3>
                   <p className='text-[12px] font-[500]'>Our Exclusive Gift Options</p>
                </div>

                <div className="col flex items-center justify-center flex-col group w-[15%]">
                   <MdOutlineSupportAgent className='text-[40px] transition-all duration-300
                    group-hover:text-[#ff5252] group-hover:translate-y-1'/>
        ...
        <hr className=" border-[#cac8c8]"/>
            ...
            <div className="footer flex py-12">
                <div className="part1 w-[25%] border-r border-[rgba(0,0,0,0.1)] ">
                   ...
                   <p className="text-[14px] font-[400] pb-4">NovaCart - Trung tâm <br/> mua sắm 
                   trực tuyến số 1 Nam Định</p> 

                     <Link className="link text-[13px]" to="mailto:someone@example.com">
                     nducanh485@gmail.com
                     </Link>

                        <span className="text-[25px] font-[600] block w-full mt-3 mb-5 text-[#ff5252]">(+84) 123 456 789
                        </span>
                    ...
                    <div className='part2_col1 w-[50%]'>
                         <h2 className="text-[18px] font-[600] mb-4">Products</h2>
                            ...
                            <ul className='list'>
                                ...
                                <li className='list-none text-[14px] w-full mb-2'><Link to="/" 
                                className='link'>Sitemap</Link></li>
                                <li className='list-none text-[14px] w-full mb-2'><Link to="/" 
                ...
                <div className="part2 w-[35%] flex pl-8  flex-col">
                    ...
                    <p className="text-[13px] ">Subscribe to our newsletter to stay updated on the 
                        latest products and offers.</p>

                        <form className='mt-5'>
                            <input type='text' className='w-full h-[45px] border outline-none pl-4 
                            pr-4 rounded-sm mb-4 focus:border-[rgba(0,0,0,0.3)]' placeholder='Your email address'/> 
    ...
    <div className="bottomStrip border-t border-[rgba(0,0,0,0.1)] py-3 bg-white">
        <div className="container flex items-center justify-between">
           ...
           <p className='text-[13px] text-center'>© 2025 NovaCart. All rights reserved.
           </p>
